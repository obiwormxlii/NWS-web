<header
	class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-base-100 border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700"
>
	<nav
